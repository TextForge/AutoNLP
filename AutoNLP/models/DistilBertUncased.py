...
class DistilBertUncased():
    ...
    def run_pipeline(self):
        ...
        model = AutoModelForSequenceClassification.from_pretrained(model_name, num_labels=num_classes).to("cuda")
        ...
        df = evaluate_results("DistilBertUncased", predictions.label_ids, preds)

        # debug
        print('Distil BERT Uncased done')
