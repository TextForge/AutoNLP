...
class KerasFT():
    ...
    def run_pipeline(self):
        ...
        df = evaluate_results("KerasFT", convert_2d_numpy_array_to_list(fasttext_preds), y_test, (len(list(le.classes_))))
        ...
        # debug
        print('Fasttext DL Done')

        
        

        return df, convert_2d_numpy_array_to_list(fasttext_preds), y_test